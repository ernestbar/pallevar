<%@ Page Title="" Language="C#" MasterPageFile="~/webPublica.Master" AutoEventWireup="true" CodeBehind="producto_comercio.aspx.cs" Inherits="GoChasquiAdmin.producto_comercio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lblClienteID" runat="server" Text="2" Visible="false"></asp:Label>
     <asp:Label ID="lblIdTipoServicio" runat="server" Text="3" Visible="false"></asp:Label>
    <asp:ObjectDataSource ID="odsProducto" runat="server" TypeName="GoChasquiAdmin.GCws1.WSGoChasquiClient" SelectMethod="ListaProductoXCliente">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="lblIdTipoServicio" Name="Id_cliente" PropertyName="Text" Type="Int32" />
        </SelectParameters>
                                ...
                                <ItemTemplate>
                                    <div class="item item-thumbnail">
                                        <a href="#" class="item-image">
                                            <img src='<%# Eval("ruta_imagen") %>' style="background: url(assets/img/slider/slider-2-cover.jpg) center 0 / cover no-repeat;" alt="" />
                                        <br></br>
