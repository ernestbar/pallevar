<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="adm_clientes_usuarios.aspx.cs" Inherits="GoChasquiAdmin.adm_clientes_usuarios" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                <div class="form-group row m-b-15">
                    <asp:Button ID="btnNuevo" class="btn btn-success col-form-label col-md-3" OnClick="btnNuevo_Click" runat="server" Text="Nuevo Usuario" />
                </div>
                            ...
                            <table id="data-table-default" class="table table-striped table-bordered" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td style="width: 80%; text-align: center;">NOMBRE</td>
            ...
            <asp:View ID="View2" runat="server">
                <div class="form-group row m-b-15">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtEmail" class="form-control m-b-5" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group row m-b-15">
