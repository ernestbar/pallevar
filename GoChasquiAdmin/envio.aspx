<%@ Page Title="" Language="C#" MasterPageFile="~/webPublica.Master" AutoEventWireup="true" CodeBehind="envio.aspx.cs" Inherits="GoChasquiAdmin.envio" %>
            ...
            <div class="checkout">
                ...
                <div class="checkout-header">
                    ...
                    <div class="row">
                        ...
                        <!-- BEGIN col-3 -->
                        <div class="col-md-3 col-sm-3">
                            <div id="dDatos" class="step" runat="server">
                                <a href="#">
                                    <div class="number">3</div>
                                    <div class="info">
                                        <div class="title">Datos</div>
                                        <div class="desc">Datos del Envío</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    ...
                    <asp:View ID="View3" runat="server">
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Nombre Destinatario:</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtNombreDestinatario" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Celular Destinatario:</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtCelularDestinatario" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Contenido:</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtContenido" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Alto del Paquete (Cm.):</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtAlto" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Ancho del Paquete (Cm.):</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtAncho" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-lg-right">Recomendaciones:</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtRecomendaciones" class="form-control m-b-5" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </asp:View>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12" style="text-align: center">
                    <img alt="" src="assets/img/gochasqui/DRIVER NADE.png" width="250" height="355">
                </div>
            </div>
        </div>
        <!-- END container -->
