<%@ Page Title="" Language="C#" MasterPageFile="~/webPublica.Master" AutoEventWireup="true" CodeBehind="restaurantes.aspx.cs" Inherits="GoChasquiAdmin.restaurantes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lblTipoNegocio" runat="server" Text="2" Visible="false"></asp:Label>
    ...
    <asp:ObjectDataSource ID="odsClientes" runat="server" TypeName="GoChasquiAdmin.GCws1.WSGoChasquiClient" SelectMethod="ListaClienteXTipoNegocio">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="lblTipoNegocio" Name="Id_negocio" DefaultValue="2" PropertyName="Text" Type="Int32" />
    ...
    <div id="work" class="content" data-scrollview="true">
        ...
        <div class="container" data-animation="true" data-animation-type="fadeInDown">
            ...
            <p class="content-desc">
                Contamos con los restaurantes mas exclusivos y solcitados de nuestra cuidad..
            </p>
            <!-- begin row -->
